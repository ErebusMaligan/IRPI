...
public class IRPIConstants {
	...
	public static final String MB_MACRO = "Macros";
	
	public static final String MB_MACRO_SAVE = "Save Macros";
	
	public static final String MB_MACRO_LOAD = "Load Macros";
	
	public static final String MB_FILE = "File";
